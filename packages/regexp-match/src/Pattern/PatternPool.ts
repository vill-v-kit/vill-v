 ...
 * 生日
 */
export const BIRTHDAY_PATTERN = /^(\d{2,4})([/\-.年]?)(\d{1,2})([/\-.月]?)(\d{1,2})日?$/

/**
 * 手机
 */
export const MOBILE_PATTERN = /^(?:(?:\+|00)86)?1[3-9]\d{9}$/
 ...
 * 中国台湾 +886 Taiwan
 */
export const MOBILE_HK_PATTERN = /^(?:0|852|\+852)?\d{8}$/
 ...
 */
export const MOBILE_TW_PATTERN = /^(?:0|886|\+886)?(?:|-)09\d{8}$/
 ...
 */
export const MOBILE_MO_PATTERN = /^(?:0|853|\+853)?(?:|-)6\d{7}$/
